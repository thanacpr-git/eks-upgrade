Before proceeding with Planning and Upgrade , please follow workshop set up instruction from Option 1 (Preferred): Running the workshop using Workshop Studio for AWS events in https://catalog.workshops.aws/eks-immersionday/en-US/introduction. Recheck that EKS cluster and Cloud 9 has been set up properly. 
